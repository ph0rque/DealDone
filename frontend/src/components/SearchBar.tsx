...
export function SearchBar({ 
    ...
    const timeoutId = setTimeout(async () => {
      if (query.trim()) {
        ...
        try {
          ...
          // Use the FileManagerAPI to search for files
          const results = await FileManagerAPI.searchFiles(state.currentPath, query.trim())
  ...
  }, [setSearchQuery, setSearchResults, state.currentPath])
