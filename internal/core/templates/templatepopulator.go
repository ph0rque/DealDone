...
// FormattingResult represents the result of formatting a value
...
// ProfessionalFormatter interface for formatting values
type ProfessionalFormatter interface {
	FormatValue(value interface{}, context FormattingContext) (*FormattingResult, error)
}

// DefaultFormatter provides basic formatting
type DefaultFormatter struct{}

func (df *DefaultFormatter) FormatValue(value interface{}, context FormattingContext) (*FormattingResult, error) {
...
func NewTemplatePopulator(templateParser *TemplateParser) *TemplatePopulator {
	return &TemplatePopulator{
		templateParser:        templateParser,
		professionalFormatter: &DefaultFormatter{},
	}
}

// SetFormatter sets a custom formatter
func (tp *TemplatePopulator) SetFormatter(formatter ProfessionalFormatter) {
	tp.professionalFormatter = formatter
}
