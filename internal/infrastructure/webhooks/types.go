...
// TriggerType represents the type of trigger that initiated the webhook
type TriggerType string

const (
	TriggerFileChange TriggerType = "file_change"
	TriggerUserButton TriggerType = "user_button"
	TriggerAnalyzeAll TriggerType = "analyze_all"
	TriggerScheduled  TriggerType = "scheduled"
	TriggerRetry      TriggerType = "retry"
	TriggerCorrection TriggerType = "user_correction"
)
...
// DocumentPayload represents the payload sent to n8n for document analysis
...
// ResultPayload represents the result payload received from n8n
...
// StatusQuery represents a status query for job tracking
...
// AuthConfig represents authentication configuration for webhooks
...
// ValidationResult represents the result of payload validation
type ValidationResult struct {
