...
// Provider constants are defined in types.go
...
type AIService struct {
	providers       map[Provider]AIServiceInterface
...
func NewAIService(config *AIConfig) *AIService {
	service := &AIService{
		providers:     make(map[Provider]AIServiceInterface),
...
func (as *AIService) SetPrimaryProvider(provider Provider) error {
...
func (as *AIService) GetAvailableProviders() []Provider {
	providers := []Provider{}
